...
//	{ cout << *it << endl; }
	...
	TFile* f = TFile::Open("tmva_background.root","recreate");
	TTree* background = new TTree("background","background tree");
	for (int i=0; i<cc-1; i++) {
		...
		background->Branch("J1_mass", &j1_mass, "j1_mass/D");
		background->Branch("J1_pt", &j1_pt, "j1_pt/D");
		background->Branch("J1_eta", &j1_eta, "j1_eta/D");
		background->Branch("J1_phi", &j1_phi, "j1_phi/D");
		background->Branch("J1_btag", &j1_btag, "j1_btag/D");

		background->Branch("J2_mass", &j2_mass, "j2_mass/D");
                background->Branch("J2_pt", &j2_pt, "j2_pt/D");
                background->Branch("J2_eta", &j2_eta, "j2_eta/D");
                background->Branch("J2_phi", &j2_phi, "j2_phi/D");
                background->Branch("J2_btag", &j2_btag, "j2_btag/D");

		background->Branch("L1_mass", &l1_mass, "l1_mass/D");
                background->Branch("L1_pt", &l1_pt, "l1_pt/D");
                background->Branch("L1_eta", &l1_eta, "l1_eta/D");
                background->Branch("L1_phi", &l1_phi, "l1_phi/D");
                background->Branch("L1_charge", &l1_charge, "l1_charge/I");

                background->Branch("L2_mass", &l2_mass, "l2_mass/D");
                background->Branch("L2_pt", &l2_pt, "l2_pt/D");
                background->Branch("L2_eta", &l2_eta, "l2_eta/D");
                background->Branch("L2_phi", &l2_phi, "l2_phi/D");
                background->Branch("L2_charge", &l2_charge, "l2_charge/I");

		background->Branch("DeltaR_ll", &dr_ll, "dr_ll/D");
		background->Branch("DeltaR_jj", &dr_jj, "dr_jj/D");

		background->Branch("H1_mass", &h1_mass, "h1_mass/D");
		background->Branch("H1_pt", &h1_pt, "h1_pt/D");
		background->Branch("H1_eta", &h1_eta, "h1_eta/D");
		background->Branch("H1_phi", &h1_phi, "h1_phi/D");

		background->Branch("H2_mass", &h2_mass, "h2_mass/D");
                background->Branch("H2_pt", &h2_pt, "h2_pt/D");
                background->Branch("H2_eta", &h2_eta, "h2_eta/D");
                background->Branch("H2_phi", &h2_phi, "h2_phi/D");

		background->Branch("HH_mass", &hh_mass, "hh_mass/D");
                background->Branch("HH_pt", &hh_pt, "hh_pt/D");
                background->Branch("HH_eta", &hh_eta, "hh_eta/D");
                background->Branch("HH_phi", &hh_phi, "hh_phi/D");
