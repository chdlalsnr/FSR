...
def main():
	...
	hreal_j1_mass = TH1F("hreal_j1_mass","Real J1 Mass Distribution", 40,0,200)
        ...
        hreal_j1_eta  = TH1F("hreal_j1_eta","Real J1 Eta Distribution", 40,-2.4,2.4)
        ...
        hreal_j2_eta  = TH1F("hreal_j2_eta","Real J2 Eta Distribution", 40,-2.4,2.4)
        ...
        hreal_l1_eta  = TH1F("hreal_l1_eta","Real L1 Eta Distribution", 40,-2.4,2.4)
        ...
        hreal_l2_eta  = TH1F("hreal_l2_eta","Real L2 Eta Distribution", 40,-2.4,2.4)
        ...
        hreal_h1_mass = TH1F("hreal_h1_mass","Real H1 Mass Distribution", 40,0,800)
        hreal_h1_pt   = TH1F("hreal_h1_pt","Real H1 Pt Distribution", 40,0,400)
        hreal_h1_eta  = TH1F("hreal_h1_eta","Real H1 Eta Distribution", 40,-2.4,2.4)
        hreal_h1_phi  = TH1F("hreal_h1_phi","Real H1 Phi Distribution", 40,-3.14,3.14)

        hreal_h2_mass = TH1F("hreal_h2_mass","Real H2 Mass Distribution", 40,0,800)
        hreal_h2_pt   = TH1F("hreal_h2_pt","Real H2 Pt Distribution", 40,0,400)
        hreal_h2_eta  = TH1F("hreal_h2_eta","Real H2 Eta Distribution", 40,-2.4,2.4)
        ...
        hreal_hh_eta  = TH1F("hreal_hh_eta","Real HH Eta Distribution", 40,-2.4,2.4)
	...
	hsig_j1_mass = TH1F("hsig_j1_mass","Signal J1 Mass Distribution", 40,0,200)
        ...
        hsig_j1_eta  = TH1F("hsig_j1_eta","Signal J1 Eta Distribution", 40,-2.4,2.4)
        ...
        hsig_j2_eta  = TH1F("hsig_j2_eta","Signal J2 Eta Distribution", 40,-2.4,2.4)
	...
	hsig_l1_mass = TH1F("hsig_l1_mass","Signal L1 Mass Distribution", 40,0,200)
        ...
        hsig_l1_eta  = TH1F("hsig_l1_eta","Signal L1 Eta Distribution", 40,-2.4,2.4)
        ...
        hsig_l2_eta  = TH1F("hsig_l2_eta","Signal L2 Eta Distribution", 40,-2.4,2.4)
	...
	hsig_h1_mass = TH1F("hsig_h1_mass","Signal H1 Mass Distribution", 40,0,800)
	hsig_h1_pt   = TH1F("hsig_h1_pt","Signal H1 Pt Distribution", 40,0,400)
	hsig_h1_eta  = TH1F("hsig_h1_eta","Signal H1 Eta Distribution", 40,-2.4,2.4)
	hsig_h1_phi  = TH1F("hsig_h1_phi","Signal H1 Phi Distribution", 40,-3.14,3.14)

	hsig_h2_mass = TH1F("hsig_h2_mass","Signal H2 Mass Distribution", 40,0,800)
	hsig_h2_pt   = TH1F("hsig_h2_pt","Signal H2 Pt Distribution", 40,0,400)
	hsig_h2_eta  = TH1F("hsig_h2_eta","Signal H2 Eta Distribution", 40,-2.4,2.4)
	...
	hsig_hh_mass = TH1F("hsig_hh_mass","Signal HH Mass Distribution", 40,0,800)
        ...
        hsig_hh_eta  = TH1F("hsig_hh_eta","Signal HH Eta Distribution", 40,-2.4,2.4)
	...
	htt_j1_mass = TH1F("htt_j1_mass","TTbar J1 Mass Distribution", 40,0,200)
        ...
        htt_j1_eta  = TH1F("htt_j1_eta","TTbar J1 Eta Distribution", 40,-2.4,2.4)
        ...
        htt_j2_eta  = TH1F("htt_j2_eta","TTbar J2 Eta Distribution", 40,-2.4,2.4)
        ...
        htt_l1_eta  = TH1F("htt_l1_eta","TTbar L1 Eta Distribution", 40,-2.4,2.4)
        ...
        htt_l2_eta  = TH1F("htt_l2_eta","TTbar L2 Eta Distribution", 40,-2.4,2.4)
	...
	htt_h1_mass = TH1F("htt_h1_mass","TTbar H1 Mass Distribution", 40,0,800)
	htt_h1_pt   = TH1F("htt_h1_pt","TTbar H1 Pt Distribution", 40,0,400)
	htt_h1_eta  = TH1F("htt_h1_eta","TTbar H1 Eta Distribution", 40,-2.4,2.4)
	htt_h1_phi  = TH1F("htt_h1_phi","TTbar H1 Phi Distribution", 40,-3.14,3.14)

	htt_h2_mass = TH1F("htt_h2_mass","TTbar H2 Mass Distribution", 40,0,800)
	htt_h2_pt   = TH1F("htt_h2_pt","TTbar H2 Pt Distribution", 40,0,400)
	htt_h2_eta  = TH1F("htt_h2_eta","TTbar H2 Eta Distribution", 40,-2.4,2.4)
	...
	htt_hh_mass  = TH1F("htt_hh_mass","TTbar HH Mass Distribution", 40,0,800)
        ...
        htt_hh_eta   = TH1F("htt_hh_eta","TTbar HH Eta Distribution", 40,-2.4,2.4)
	...
	hdy_j1_mass = TH1F("hdy_j1_mass","DY J1 Mass Distribution", 40,0,200)
        ...
        hdy_j1_eta  = TH1F("hdy_j1_eta","DY J1 Eta Distribution", 40,-2.4,2.4)
        ...
        hdy_j2_eta  = TH1F("hdy_j2_eta","DY J2 Eta Distribution", 40,-2.4,2.4)
        ...
        hdy_l1_eta  = TH1F("hdy_l1_eta","DY L1 Eta Distribution", 40,-2.4,2.4)
        ...
        hdy_l2_eta  = TH1F("hdy_l2_eta","DY L2 Eta Distribution", 40,-2.4,2.4)
	...
	hdy_h1_mass = TH1F("hdy_h1_mass","DY H1 Mass Distribution", 40,0,800)
	hdy_h1_pt   = TH1F("hdy_h1_pt","DY H1 Pt Distribution", 40,0,400)
	hdy_h1_eta  = TH1F("hdy_h1_eta","DY H1 Eta Distribution", 40,-2.4,2.4)
	hdy_h1_phi  = TH1F("hdy_h1_phi","DY H1 Phi Distribution", 40,-3.14,3.14)

	hdy_h2_mass = TH1F("hdy_h2_mass","DY H2 Mass Distribution", 40,0,800)
	hdy_h2_pt   = TH1F("hdy_h2_pt","DY H2 Pt Distribution", 40,0,400)
	hdy_h2_eta  = TH1F("hdy_h2_eta","DY H2 Eta Distribution", 40,-2.4,2.4)
	...
	hdy_hh_eta   = TH1F("hdy_hh_eta","DY HH Eta Distribution", 40,-2.4,2.4)
	...
	hwj_j1_mass = TH1F("hwj_j1_mass","WJ J1 Mass Distribution", 40,0,200)
        ...
        hwj_j1_eta  = TH1F("hwj_j1_eta","WJ J1 Eta Distribution", 40,-2.4,2.4)
        ...
        hwj_j2_eta  = TH1F("hwj_j2_eta","WJ J2 Eta Distribution", 40,-2.4,2.4)
        ...
        hwj_l1_eta  = TH1F("hwj_l1_eta","WJ L1 Eta Distribution", 40,-2.4,2.4)
        ...
        hwj_l2_eta  = TH1F("hwj_l2_eta","WJ L2 Eta Distribution", 40,-2.4,2.4)
        ...
        hwj_h1_mass = TH1F("hwj_h1_mass","WJ H1 Mass Distribution", 40,0,800)
        hwj_h1_pt   = TH1F("hwj_h1_pt","WJ H1 Pt Distribution", 40,0,400)
        hwj_h1_eta  = TH1F("hwj_h1_eta","WJ H1 Eta Distribution", 40,-2.4,2.4)
        hwj_h1_phi  = TH1F("hwj_h1_phi","WJ H1 Phi Distribution", 40,-3.14,3.14)

        hwj_h2_mass = TH1F("hwj_h2_mass","WJ H2 Mass Distribution", 40,0,800)
        hwj_h2_pt   = TH1F("hwj_h2_pt","WJ H2 Pt Distribution", 40,0,400)
        hwj_h2_eta  = TH1F("hwj_h2_eta","WJ H2 Eta Distribution", 40,-2.4,2.4)
        ...
        hwj_hh_eta  = TH1F("hwj_hh_eta","WJ HH Eta Distribution", 40,-2.4,2.4)
	...
	hst_j1_mass = TH1F("hst_j1_mass","ST J1 Mass Distribution", 40,0,200)
        ...
        hst_j1_eta  = TH1F("hst_j1_eta","ST J1 Eta Distribution", 40,-2.4,2.4)
        ...
        hst_j2_eta  = TH1F("hst_j2_eta","ST J2 Eta Distribution", 40,-2.4,2.4)
        ...
        hst_l1_eta  = TH1F("hst_l1_eta","ST L1 Eta Distribution", 40,-2.4,2.4)
        ...
        hst_l2_eta  = TH1F("hst_l2_eta","ST L2 Eta Distribution", 40,-2.4,2.4)
	...
	hst_h1_mass = TH1F("hst_h1_mass","ST H1 Mass Distribution", 40,0,800)
	hst_h1_pt   = TH1F("hst_h1_pt","ST H1 Pt Distribution", 40,0,400)
	hst_h1_eta  = TH1F("hst_h1_eta","ST H1 Eta Distribution", 40,-2.4,2.4)
	hst_h1_phi  = TH1F("hst_h1_phi","ST H1 Phi Distribution", 40,-3.14,3.14)

	hst_h2_mass = TH1F("hst_h2_mass","ST H2 Mass Distribution", 40,0,800)
        hst_h2_pt   = TH1F("hst_h2_pt","ST H2 Pt Distribution", 40,0,400)
        hst_h2_eta  = TH1F("hst_h2_eta","ST H2 Eta Distribution", 40,-2.4,2.4)
	...
	hst_hh_mass = TH1F("hst_hh_mass","ST HH Mass Distribution", 40,0,800)
        ...
        hst_hh_eta  = TH1F("hst_hh_eta","ST HH Eta Distribution", 40,-2.4,2.4)
	...
	corr = 730150216*2.26 #/2.56688082201e+12
	...
	for fname in flist:
		...
		# TT
		sf_tt_2l2nu = corr*0.0122805750199/4233239348.72
		sf_tt_semi  = corr*0.050844914675/32366940321.3
		sf_tt_had   = corr*0.0525119610578/31432310862.9
		...
		# DY
		sf_dy_0j  = corr*0.672375374391/2.83853150541e+11
		sf_dy_1j  = corr*0.124750637645/2.24631958677e+11
		sf_dy_2j  = corr*0.046677298718/1.02265928169e+11
		if (dr == 'dy_0j' or dr == 'dy_1j' or dr == 'dy_2j'):
		...
		sf_wj_3j  = 0
		sf_wj_4j  = 0
		if (dr == 'wj_1j' or dr == 'wj_2j' or dr == 'wj_3j' or dr == 'wj_4j'):
		...
		# ST
                sf_st_tW_anti = corr*0.00497335504198/3042330.0
                sf_st_tW_top  = corr*0.00497335504198/5448050.0
		sf_st_tchannel_anti = corr*0.0112525630838/24896251.0
		sf_st_tchannel_top  = corr*0.0188931923383/34673740.0
                sf_st_schannel_incl = corr*0.00046677298718/3127770.89
	...
	err_j1_mass = TH1F("err_j1_mass","Error J1 Mass Distribution", 40,0,200)
        ...
        err_j1_eta  = TH1F("err_j1_eta","Error J1 Eta Distribution", 40,-2.4,2.4)
        ...
        err_j2_eta  = TH1F("err_j2_eta","Error J2 Eta Distribution", 40,-2.4,2.4)
        ...
        err_l1_eta  = TH1F("err_l1_eta","Error L1 Eta Distribution", 40,-2.4,2.4)
        ...
        err_l2_eta  = TH1F("err_l2_eta","Error L2 Eta Distribution", 40,-2.4,2.4)
        ...
        err_h1_mass = TH1F("err_h1_mass","Error H1 Mass Distribution", 40,0,800)
        err_h1_pt   = TH1F("err_h1_pt","Error H1 Pt Distribution", 40,0,400)
        err_h1_eta  = TH1F("err_h1_eta","Error H1 Eta Distribution", 40,-2.4,2.4)
        err_h1_phi  = TH1F("err_h1_phi","Error H1 Phi Distribution", 40,-3.14,3.14)

        err_h2_mass = TH1F("err_h2_mass","Error H2 Mass Distribution", 40,0,800)
        err_h2_pt   = TH1F("err_h2_pt","Error H2 Pt Distribution", 40,0,400)
        err_h2_eta  = TH1F("err_h2_eta","Error H2 Eta Distribution", 40,-2.4,2.4)
        ...
        err_hh_eta  = TH1F("err_hh_eta","Error HH Eta Distribution", 40,-2.4,2.4)
...
#        stack_hh_eta.SetMaximum(400)
        ...
        stack_hh_eta.GetYaxis().SetTitle("Events/.12")
...
#        stack_hh_phi.SetMaximum(500)
        ...
        stack_hh_phi.GetYaxis().SetTitle("Events/.16rad")
