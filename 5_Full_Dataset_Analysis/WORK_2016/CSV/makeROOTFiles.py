...
def main():
	...
	for fname in flist:
		...
		h_J1_eta  = TH1D("J1_eta", "Eta Distribution of Leading Jet", 40, -2.4, 2.4)
		...
		h_J2_eta  = TH1D("J2_eta", "Eta Distribution of Sub-leading Jet", 40, -2.4, 2.4)
		...
		h_L1_eta  = TH1D("L1_eta", "Eta Distribution of Leading Lepton", 40, -2.4, 2.4)
		...
		h_L2_eta  = TH1D("L2_eta", "Eta Distribution of Sub-leading Lepton", 40, -2.4, 2.4)
		...
		h_H1_mass = TH1D("H1_mass", "Mass Distribution of H1 <- MuMu", 40, 0, 800)
		...
		h_H1_eta  = TH1D("H1_eta", "Eta Distribution of H1 <- MuMu", 40, -2.4, 2.4)
		...
		h_H2_mass = TH1D("H2_mass", "Mass Distribution of H2 <- bb", 40, 0, 800)
		...
		h_H2_eta  = TH1D("H2_eta", "Eta Distribution of H2 <- bb", 40, -2.4, 2.4)
		h_H2_eta.GetXaxis().SetTitle("Eta")
		h_H2_phi  = TH1D("H2_phi", "Phi Distribution of H2 <- bb", 40, -3.14, 3.14)
		h_H2_phi.GetXaxis().SetTitle("Phi")

		h_HH_mass = TH1D("HH_mass", "Mass Distribution of HH", 40, 0, 800)
		h_HH_mass.GetXaxis().SetTitle("Invariant mass [GeV]")
		h_HH_pt   = TH1D("HH_pt", "Transverse Momentum Distribution of HH", 40, 0, 800)
		h_HH_pt.GetXaxis().SetTitle("Transverse momentum [GeV]")
		h_HH_eta  = TH1D("HH_eta", "Eta Distribution of HH", 40, -2.4, 2.4)
...
#		for i in range(1,h_J1_mass.GetNbinsX()+1):
#
#			h_J1_mass.SetBinContent(i,(h_J1_mass.GetBinContent(i)*genweight))
#			h_J1_pt.SetBinContent(i,(h_J1_pt.GetBinContent(i)*genweight))
#			h_J1_eta.SetBinContent(i,(h_J1_eta.GetBinContent(i)*genweight))
#			h_J1_phi.SetBinContent(i,(h_J1_phi.GetBinContent(i)*genweight))
#			h_J1_btag.SetBinContent(i,(h_J1_btag.GetBinContent(i)*genweight))
#
#			h_J2_mass.SetBinContent(i,(h_J2_mass.GetBinContent(i)*genweight))
#                        h_J2_pt.SetBinContent(i,(h_J2_pt.GetBinContent(i)*genweight))
#                        h_J2_eta.SetBinContent(i,(h_J2_eta.GetBinContent(i)*genweight))
#                        h_J2_phi.SetBinContent(i,(h_J2_phi.GetBinContent(i)*genweight))
#                        h_J2_btag.SetBinContent(i,(h_J2_btag.GetBinContent(i)*genweight))
#
#			h_L1_mass.SetBinContent(i,(h_L1_mass.GetBinContent(i)*genweight))
#                        h_L1_pt.SetBinContent(i,(h_L1_pt.GetBinContent(i)*genweight))
#                        h_L1_eta.SetBinContent(i,(h_L1_eta.GetBinContent(i)*genweight))
#                        h_L1_phi.SetBinContent(i,(h_L1_phi.GetBinContent(i)*genweight))
#                        h_L1_charge.SetBinContent(i,(h_L1_charge.GetBinContent(i)*genweight))
#
#                        h_L2_mass.SetBinContent(i,(h_L2_mass.GetBinContent(i)*genweight))
#                        h_L2_pt.SetBinContent(i,(h_L2_pt.GetBinContent(i)*genweight))
#                        h_L2_eta.SetBinContent(i,(h_L2_eta.GetBinContent(i)*genweight))
#                        h_L2_phi.SetBinContent(i,(h_L2_phi.GetBinContent(i)*genweight))
#                        h_L2_charge.SetBinContent(i,(h_L2_charge.GetBinContent(i)*genweight))
#
#			h_dr_ll.SetBinContent(i,(h_dr_ll.GetBinContent(i)*genweight))
#			h_dr_jj.SetBinContent(i,(h_dr_jj.GetBinContent(i)*genweight))
#
#			h_H1_mass.SetBinContent(i,(h_H1_mass.GetBinContent(i)*genweight))
#			h_H1_pt.SetBinContent(i,(h_H1_pt.GetBinContent(i)*genweight))
#			h_H1_eta.SetBinContent(i,(h_H1_eta.GetBinContent(i)*genweight))
#			h_H1_phi.SetBinContent(i,(h_H1_phi.GetBinContent(i)*genweight))
#
#			h_H2_mass.SetBinContent(i,(h_H2_mass.GetBinContent(i)*genweight))
#                        h_H2_pt.SetBinContent(i,(h_H2_pt.GetBinContent(i)*genweight))
#                        h_H2_eta.SetBinContent(i,(h_H2_eta.GetBinContent(i)*genweight))
#                        h_H2_phi.SetBinContent(i,(h_H2_phi.GetBinContent(i)*genweight))
#
#			h_HH_mass.SetBinContent(i,(h_HH_mass.GetBinContent(i)*genweight))
#                        h_HH_pt.SetBinContent(i,(h_HH_pt.GetBinContent(i)*genweight))
#                        h_HH_eta.SetBinContent(i,(h_HH_eta.GetBinContent(i)*genweight))
#                        h_HH_phi.SetBinContent(i,(h_HH_phi.GetBinContent(i)*genweight))
