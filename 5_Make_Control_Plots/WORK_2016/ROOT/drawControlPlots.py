...
def main():
	...
	for fname in flist:
		...
		# TT
		sf_tt_2l2nu = lumi*88.4/4891620336.1
		sf_tt_semi  = lumi*366/32366940321.3
		sf_tt_had   = lumi*378/21432310862.9
		...
		if (dr == 'tt_2l2nu' or dr == "tt_semi" or dr == "tt_had"):
			if (dr == 'tt_2l2nu'):
				...
				for i in range(1,h1_mass.GetNbinsX()+1):
					...
					yields += j1_mass.GetBinContent(i)*sf_tt_2l2nu
				print("tt_2l2nu yield is %d"%(yields))
			...
			if (dr == 'tt_semi'):
				...
				for i in range(1,h1_mass.GetNbinsX()+1):
					...
					yields += j1_mass.GetBinContent(i)*sf_tt_semi
				print("tt_semi yield is %d"%(yields))
			...
			if (dr == 'tt_had'):
				...
				for i in range(1,h1_mass.GetNbinsX()+1):
					...
					yields += j1_mass.GetBinContent(i)*sf_tt_had
				print("tt_had yield is %d"%(yields))

		# DY
		sf_dy_m50 = lumi*6080/1.89714162185e+12
		sf_dy_0j  = lumi*4840/2.83853150541e+11
		sf_dy_1j  = lumi*898/2.24631958677e+11
		sf_dy_2j  = lumi*336/1.02265928169e+11
		...
		if (dr == 'dy_m50' or dr == 'dy_0j' or dr == 'dy_1j' or dr == 'dy_2j'):
			if (dr == 'dy_m50'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_dy_m50
				print("dy_m50 yield is %d"%(yields))
			...
			if (dr == 'dy_0j'):
				...
				for i in range(1,h1_mass.GetNbinsX()+1):
					...
					yields += j1_mass.GetBinContent(i)*sf_dy_0j
				print("dy_0j yield is %d"%(yields))
			...
			if (dr == 'dy_1j'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_dy_1j
				print("dy_1j yield is %d"%(yields))
			...
			if (dr == 'dy_2j'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_dy_2j
				print("dy_2j yield is %d"%(yields))

		# WJ
		sf_wj_jets= lumi*61500/86916455.0
		sf_wj_1j  = lumi*9440/45283121.0
		sf_wj_2j  = lumi*3250/30064264.0
		sf_wj_3j  = lumi*1150/19798117.0
		sf_wj_4j  = lumi*634/9116657.0
		...
		if (dr == 'wj_jets' or dr == 'wj_1j' or dr == 'wj_2j' or dr == 'wj_3j' or dr == 'wj_4j'):
			if (dr == 'wj_jets'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_wj_jets
				print("wj_jets yield is %d"%(yields))
			...
			if (dr == 'wj_1j'):
				...
				for i in range(1,h1_mass.GetNbinsX()+1):
					...
					yields += j1_mass.GetBinContent(i)*sf_wj_1j
				print("wj_1j yield is %d"%(yields))
			...
			if (dr == 'wj_2j'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_wj_2j
				print("wj_2j yield is %d"%(yields))
			...
			if (dr == 'wj_3j'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_wj_3j
				print("wj_3j yield is %d"%(yields))
			...
			if (dr == 'wj_4j'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_wj_4j
				print("wj_4j yield is %d"%(yields))

		# ST
                sf_st_schannel_incl = lumi*3.36/3370668.5184
		sf_st_tchannel_top  = lumi*136/58403420.0
		sf_st_tchannel_anti = lumi*81/38811017.0
                sf_st_tW_top  = lumi*35.8/6952830.0
                sf_st_tW_anti = lumi*35.8/6933094.0
				...
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_st_schannel_incl
				print("st_schannel_incl yield is %d"%(yields))
			...
			if (dr == 'st_tchannel_top'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_st_tchannel_top
				print("st_tchannel_top yield is %d"%(yields))
			...
			if (dr == 'st_tchannel_anti'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_st_tchannel_anti
				print("st_tchannel_anti yield is %d"%(yields))
			...
			if (dr == 'st_tW_top'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_st_tW_top
				print("st_tW_top yield is %d"%(yields))
			...
			if (dr == 'st_tW_anti'):
				yields = 0
					...
					yields += j1_mass.GetBinContent(i)*sf_st_tW_anti
				print("st_tW_anti yield is %d"%(yields))

		f.Close()

	rh1_yield,rh2_yield,rhh_yield = 0,0,0
	for i in range(1,hreal_h1_mass.GetNbinsX()+1):
	...
	err_j1_mass = TH1F("err_j1_mass","Error J1 Mass Distribution", 20,0,200)
        err_j1_pt   = TH1F("err_j1_pt","Error J1 Pt Distribution", 20,0,200)
        ...
        err_j2_pt   = TH1F("err_j2_pt","Error J2 Pt Distribution", 20,0,200)
        ...
        err_l1_pt   = TH1F("err_l1_pt","Error L1 Pt Distribution", 20,0,200)
        ...
        err_l2_pt   = TH1F("err_l2_pt","Error L2 Pt Distribution", 20,0,200)
        ...
        err_h1_mass = TH1F("err_h1_mass","Error H1 Mass Distribution", 20,0,400)
        ...
        err_h2_mass = TH1F("err_h2_mass","Error H2 Mass Distribution", 20,0,400)
        ...
        err_hh_pt   = TH1F("err_hh_pt","Error HH Pt Distribution", 20,0,800)
	...
	for i in range(1,err_j1_mass.GetNbinsX()+1):
		...
		err_j1_mass.SetBinError(i,err_j1_mass.GetBinContent(i)**.5+err_j1_mass.GetBinContent(i)*0.116)
		err_j1_pt.SetBinError(i,err_j1_pt.GetBinContent(i)**.5+err_j1_pt.GetBinContent(i)*0.116)
		err_j1_eta.SetBinError(i,err_j1_eta.GetBinContent(i)**.5+err_j1_eta.GetBinContent(i)*0.116)
		err_j1_phi.SetBinError(i,err_j1_phi.GetBinContent(i)**.5+err_j1_phi.GetBinContent(i)*0.116)
		err_j1_btag.SetBinError(i,err_j1_btag.GetBinContent(i)**.5+err_j1_btag.GetBinContent(i)*0.116)

		err_j2_mass.SetBinError(i,err_j2_mass.GetBinContent(i)**.5+err_j2_mass.GetBinContent(i)*0.116)
                err_j2_pt.SetBinError(i,err_j2_pt.GetBinContent(i)**.5+err_j2_pt.GetBinContent(i)*0.116)
                err_j2_eta.SetBinError(i,err_j2_eta.GetBinContent(i)**.5+err_j2_eta.GetBinContent(i)*0.116)
                err_j2_phi.SetBinError(i,err_j2_phi.GetBinContent(i)**.5+err_j2_phi.GetBinContent(i)*0.116)
                err_j2_btag.SetBinError(i,err_j2_btag.GetBinContent(i)**.5+err_j2_btag.GetBinContent(i)*0.116)

		err_l1_mass.SetBinError(i,err_l1_mass.GetBinContent(i)**.5+err_l1_mass.GetBinContent(i)*0.116)
                err_l1_pt.SetBinError(i,err_l1_pt.GetBinContent(i)**.5+err_l1_pt.GetBinContent(i)*0.116)
                err_l1_eta.SetBinError(i,err_l1_eta.GetBinContent(i)**.5+err_l1_eta.GetBinContent(i)*0.116)
                err_l1_phi.SetBinError(i,err_l1_phi.GetBinContent(i)**.5+err_l1_phi.GetBinContent(i)*0.116)
                err_l1_charge.SetBinError(i,err_l1_charge.GetBinContent(i)**.5+err_l1_charge.GetBinContent(i)*0.116)

                err_l2_mass.SetBinError(i,err_l2_mass.GetBinContent(i)**.5+err_l2_mass.GetBinContent(i)*0.116)
                err_l2_pt.SetBinError(i,err_l2_pt.GetBinContent(i)**.5+err_l2_pt.GetBinContent(i)*0.116)
                err_l2_eta.SetBinError(i,err_l2_eta.GetBinContent(i)**.5+err_l2_eta.GetBinContent(i)*0.116)
                err_l2_phi.SetBinError(i,err_l2_phi.GetBinContent(i)**.5+err_l2_phi.GetBinContent(i)*0.116)
                err_l2_charge.SetBinError(i,err_l2_charge.GetBinContent(i)**.5+err_l2_charge.GetBinContent(i)*0.116)

		err_dr_ll.SetBinError(i,err_dr_ll.GetBinContent(i)**.5+err_dr_ll.GetBinContent(i)*0.116)
		err_dr_jj.SetBinError(i,err_dr_jj.GetBinContent(i)**.5+err_dr_jj.GetBinContent(i)*0.116)

		err_h1_mass.SetBinError(i,err_h1_mass.GetBinContent(i)**.5+err_h1_mass.GetBinContent(i)*0.116)
                err_h1_pt.SetBinError(i,err_h1_pt.GetBinContent(i)**.5+err_h1_pt.GetBinContent(i)*0.116)
                err_h1_eta.SetBinError(i,err_h1_eta.GetBinContent(i)**.5+err_h1_eta.GetBinContent(i)*0.116)
                err_h1_phi.SetBinError(i,err_h1_phi.GetBinContent(i)**.5+err_h1_phi.GetBinContent(i)*0.116)

		err_h2_mass.SetBinError(i,err_h2_mass.GetBinContent(i)**.5+err_h2_mass.GetBinContent(i)*0.116)
                err_h2_pt.SetBinError(i,err_h2_pt.GetBinContent(i)**.5+err_h2_pt.GetBinContent(i)*0.116)
                err_h2_eta.SetBinError(i,err_h2_eta.GetBinContent(i)**.5+err_h2_eta.GetBinContent(i)*0.116)
                err_h2_phi.SetBinError(i,err_h2_phi.GetBinContent(i)**.5+err_h2_phi.GetBinContent(i)*0.116)

		err_hh_mass.SetBinError(i,err_hh_mass.GetBinContent(i)**.5+err_hh_mass.GetBinContent(i)*0.116)
                err_hh_pt.SetBinError(i,err_hh_pt.GetBinContent(i)**.5+err_hh_pt.GetBinContent(i)*0.116)
                err_hh_eta.SetBinError(i,err_hh_eta.GetBinContent(i)**.5+err_hh_eta.GetBinContent(i)*0.116)
                err_hh_phi.SetBinError(i,err_hh_phi.GetBinContent(i)**.5+err_hh_phi.GetBinContent(i)*0.116)
...
#	ff.Close()
	...
	c1 = TCanvas("c1","Stacked Histograms of Basic Kinematics l1", 900,600)

	c1.Divide(2,2)
        c1.cd(1)
	stack_l1_mass.Draw("hist")
	sel = hreal_l1_mass.GetMaximumBin()
        ylim = hreal_l1_mass.GetBinCenter(sel)
        stack_l1_mass.GetYaxis().SetRangeUser(0,ylim+1000)
	stack_l1_mass.GetXaxis().SetTitle("Invariant Mass[GeV]")
	stack_l1_mass.GetYaxis().SetTitle("Events/20GeV")
	hsig_l1_mass.SetLineColor(kRed)
	hsig_l1_mass.Draw("hist same")
	hreal_l1_mass.SetLineColor(kBlack)
        hreal_l1_mass.Draw("hist e1 same")
	err_l1_mass.SetFillColor(kBlue)
	err_l1_mass.SetFillStyle(3003)
	err_l1_mass.Draw("e2 same")
	lst_l1_mass.Draw()

	c1.cd(2)
	stack_l1_pt.Draw("hist")
	sel = hreal_l1_pt.GetMaximumBin()
        ylim = hreal_l1_pt.GetBinCenter(sel)
        stack_l1_pt.GetYaxis().SetRangeUser(0,ylim+1000)
        stack_l1_pt.GetXaxis().SetTitle("Transverse Momentum[GeV]")
        stack_l1_pt.GetYaxis().SetTitle("Events/20GeV")
        hsig_l1_pt.SetLineColor(kRed)
        hsig_l1_pt.Draw("hist same")
	hreal_l1_pt.SetLineColor(kBlack)
        hreal_l1_pt.Draw("hist e1 same")
        err_l1_pt.SetFillColor(kBlue)
        err_l1_pt.SetFillStyle(3003)
        err_l1_pt.Draw("e2 same")
        lst_l1_pt.Draw()

	c1.cd(3)
	stack_l1_eta.Draw("hist")
	sel = hreal_l1_eta.GetMaximumBin()
        ylim = hreal_l1_eta.GetBinCenter(sel)
        stack_l1_eta.GetYaxis().SetRangeUser(0,ylim+1000)
        stack_l1_eta.GetXaxis().SetTitle("Eta")
        stack_l1_eta.GetYaxis().SetTitle("Events/.24")
        hsig_l1_eta.SetLineColor(kRed)
        hsig_l1_eta.Draw("hist same")
	hreal_l1_eta.SetLineColor(kBlack)
        hreal_l1_eta.Draw("hist e1 same")
        err_l1_eta.SetFillColor(kBlue)
        err_l1_eta.SetFillStyle(3003)
        err_l1_eta.Draw("e2 same")
        lst_l1_eta.Draw()

	c1.cd(4)
	stack_l1_phi.Draw("hist")
	sel = hreal_l1_phi.GetMaximumBin()
        ylim = hreal_l1_phi.GetBinCenter(sel)
        stack_l1_phi.GetYaxis().SetRangeUser(0,ylim+1000)
        stack_l1_phi.GetXaxis().SetTitle("Phi")
        stack_l1_phi.GetYaxis().SetTitle("Events/.32rad")
        hsig_l1_phi.SetLineColor(kRed)
        hsig_l1_phi.Draw("hist same")
	hreal_l1_phi.SetLineColor(kBlack)
        hreal_l1_phi.Draw("hist e1 same")
        err_l1_phi.SetFillColor(kBlue)
        err_l1_phi.SetFillStyle(3003)
        err_l1_phi.Draw("e2 same")
        lst_l1_phi.Draw()
