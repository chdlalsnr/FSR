...
def main():
	...
	target = 'target'
	feature = ['jet1_mass','jet1_pt','jet1_eta','jet1_phi','jet2_mass','jet2_pt','jet2_eta','jet2_phi','lep1_mass','lep1_pt','lep1_eta','lep1_phi','lep2_mass','lep2_pt','lep2_eta','lep2_phi','dr_ll','dr_jj','met_pt','met_phi','h1_mass','h1_pt','h1_eta','h1_phi','h2_mass','h2_pt','h2_eta','h2_phi','higgsness','topness']
...
#
#	pca_df = pd.DataFrame(pca_arr, index=df.index,
#				columns=["PC{0}".format(num+1) for num in range(df.shape[1])])
#
...
#	ax1.axvline(x='PC7', color='red', linestyle='dashed',alpha=0.7)
...
#	ax2.axvline(x='PC16', color='gray', linestyle='dashed',alpha=0.7)
#
