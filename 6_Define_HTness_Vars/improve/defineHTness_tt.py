...
#        flist = glob.glob('/xrootd/store/mc/RunIISummer16NanoAODv7/GluGluToHHTo2B2VTo2L2Nu_node_SM_13TeV-madgraph*/*/*/*/*')
	...
	for fname in flist:
		...
		for i in range(event_num):
			...
			opt = minimize(defineHiggsness, ini, constraints=cons, bounds=bnd, method='SLSQP', options={'ftol':5}) #'disp':True})
	...
	df.to_csv("htness_tt.csv", header=True, index=False)
