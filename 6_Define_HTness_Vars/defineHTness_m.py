...
#				dilep.append(sslep_phi)
		...
		model = Minuit(todular, a=1,b=1,c=1,d=1,e=1,f=1,g=1,h=1, a_err=.2,b_err=.2,c_err=.2,d_err=.2,e_err=.2,f_err=.2,g_err=.2,h_err=.2)
		...
		for i in range(0,100):
			...
			nu1_p4.SetPtEtaPhiM(a,b,c, 0)
			nu2_p4.SetPtEtaPhiM(d,e,f,0)
			...
			todular = ((t3_p4.M()**2-t_mass**2)**2/sig_t**4) + ((w2_p4.M()**2-w_mass**2)**2/sig_w**4) + ((t1_p4.M()**2-t_mass**2)**2/sig_t**4) + ((w1_p4.M()**2-w_mass**2)**2/sig_w**4)
