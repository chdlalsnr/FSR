...
def main(dataset):
	...
	for fname in flist:
		...
		for i in range(event_num):
			...
			genweight = genweight + t.genWeight
			...
			for j in range(t.nJet):
				...
				if (t.Jet_btagDeepFlavB.__getitem__(j) > 0.3093): btag_id += 1
